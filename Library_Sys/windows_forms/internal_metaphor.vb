Public Class internal_metaphor
    ...
    Private Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        If txt_book_1.Text = "" Then
            ...
            Exit Sub
        End If
        retreving.retrive.save("insert into internal_metaphor(process_num,metaphor_name,metaphor_id,metaphor_date,name1,name2,name3,name4) values ('" + txt_process_num.Text + "','" + txt_metaphor_name.Text + "','" + txt_metaphor_id.Text + "','" + dtp_metaphor_date.Text + "','" + txt_book_1.Text + "','" + txt_book_2.Text + "','" + txt_book_3.Text + "','" + txt_book_4.Text + "')")
    ...
    Private Sub internal_metaphor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
