Public Class month_inventory
    ...
    Private Sub month_inventory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        If txt_current_num.Text = "" Then
            ...
            Exit Sub
        End If
        retreving.retrive.save("insert into month_inventory (process_num,year,month,day,time,emp_name,books_original_num,books_current_num,books_lost_num) values ('" + txt_process_num.Text + "','" + txt_year.Text + "','" + cmb_month.Text + "','" + cmb_day.Text + "','" + txt_time.Text + "','" + cmb_emp.Text + "','" + txt_original_num.Text + "','" + txt_current_num.Text + "','" + txt_lost_num.Text + "')")
        clear_txt()
    End Sub
